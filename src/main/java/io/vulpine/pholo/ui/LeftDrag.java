...
public class LeftDrag < T extends Node > extends HBox
{
  private final T content;

  private final Rectangle rect;

  public LeftDrag( final T content ) {
    rect = new Rectangle();
    rect.setWidth(2);
    ...
    getChildren().addAll(rect, content);
  }
  ...
  private void onDragRelease( final MouseDragEvent mouseDragEvent ) {
    prevX = -1;
    prevY = -1;
  }
